(function () {
  ...
  // в”Ђв”Ђ Р†РєРѕРЅРєРё SVG в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  ...
  // Р†РєРѕРЅРєРё РґР»СЏ РјРµРЅСЋ СЂРµРґР°РіСѓРІР°РЅРЅСЏ СЃРїРёСЃРєС–РІ
  ...
  function addLang() {
    ...
    Lampa.Lang.add({
      settings_local_lists_settings: { uk: 'РќР°Р»Р°С€С‚СѓРІР°РЅРЅСЏ СЃРїРёСЃРєС–РІ', ru: 'РќР°СЃС‚СЂРѕР№РєРё СЃРїРёСЃРєРѕРІ', en: 'Lists Settings' },
      local_lists_title: { uk: 'РњРѕС— СЃРїРёСЃРєРё', ru: 'РњРѕРё СЃРїРёСЃРєРё', en: 'My Lists' },
      local_lists_button: { uk: 'РЎРїРёСЃРєРё', ru: 'РЎРїРёСЃРєРё', en: 'Lists' },
      local_lists_settings: { uk: 'РќР°Р»Р°С€С‚СѓРІР°РЅРЅСЏ СЃРїРёСЃРєС–РІ', ru: 'РќР°СЃС‚СЂРѕР№РєРё СЃРїРёСЃРєРѕРІ', en: 'Lists Settings' },
      local_lists_github_auth: { uk: 'GitHub Token', ru: 'GitHub Token', en: 'GitHub Token' },
      local_lists_no_token: { 
        uk: 'РЎРїРѕС‡Р°С‚РєСѓ РїРѕС‚СЂС–Р±РЅР° Р°РІС‚РѕСЂРёР·Р°С†С–СЏ (РІРєР°Р¶С–С‚СЊ GitHub Token)', 
        ru: 'РЎРЅР°С‡Р°Р»Р° С‚СЂРµР±СѓРµС‚СЃСЏ Р°РІС‚РѕСЂРёР·Р°С†РёСЏ (СѓРєР°Р¶РёС‚Рµ GitHub Token)', 
        en: 'Authorization required first (specify GitHub Token)' 
      },
      local_lists_cloud_backup: { uk: 'РЎРёРЅС…СЂРѕРЅС–Р·СѓРІР°С‚Рё Р· С…РјР°СЂРѕСЋ (СЃРїРёСЃРєРё + РІРёР±СЂР°РЅРµ)', ru: 'РЎРёРЅС…СЂРѕРЅРёР·РёСЂРѕРІР°С‚СЊ СЃ РѕР±Р»Р°РєРѕРј (СЃРїРёСЃРєРё + РёР·Р±СЂР°РЅРЅРѕРµ)', en: 'Sync with Cloud (lists + favorites)' },
      local_lists_cloud_overwrite: { uk: 'РџРµСЂРµР·Р°РїРёСЃР°С‚Рё СЃРїРёСЃРєРё РІ С…РјР°СЂС–', ru: 'РџРµСЂРµР·Р°РїРёСЃР°С‚СЊ СЃРїРёСЃРєРё РІ РѕР±Р»Р°РєРµ', en: 'Overwrite lists in Cloud' },
      local_lists_cloud_overwrite_confirm: { uk: 'РџРµСЂРµР·Р°РїРёСЃР°С‚Рё С…РјР°СЂСѓ РїРѕС‚РѕС‡РЅРёРјРё СЃРїРёСЃРєР°РјРё?', ru: 'РџРµСЂРµР·Р°РїРёСЃР°С‚СЊ РѕР±Р»Р°РєРѕ С‚РµРєСѓС‰РёРјРё СЃРїРёСЃРєР°РјРё?', en: 'Overwrite cloud with current lists?' },
      local_lists_cloud_overwritten: { uk: 'Р”Р°РЅС– РІ С…РјР°СЂС– СѓСЃРїС–С€РЅРѕ РїРµСЂРµР·Р°РїРёСЃР°РЅРѕ', ru: 'Р”Р°РЅРЅС‹Рµ РІ РѕР±Р»Р°РєРµ СѓСЃРїРµС€РЅРѕ РїРµСЂРµР·Р°РїРёСЃР°РЅС‹', en: 'Cloud data successfully overwritten' },
      local_lists_cloud_restore: { uk: 'Р’С–РґРЅРѕРІРёС‚Рё Р· С…РјР°СЂРё', ru: 'Р’РѕСЃСЃС‚Р°РЅРѕРІРёС‚СЊ РёР· РѕР±Р»Р°РєР°', en: 'Restore from Cloud' },
      local_lists_cloud_restore_confirm: { uk: 'Р—Р°РјС–РЅРёС‚Рё Р»РѕРєР°Р»СЊРЅС– СЃРїРёСЃРєРё РґР°РЅРёРјРё Р· С…РјР°СЂРё?', ru: 'Р—Р°РјРµРЅРёС‚СЊ Р»РѕРєР°Р»СЊРЅС‹Рµ СЃРїРёСЃРєРё РґР°РЅРЅС‹РјРё РёР· РѕР±Р»Р°РєР°?', en: 'Replace local lists with cloud data?' },
      local_lists_cloud_restored: { uk: 'Р”Р°РЅС– Р· С…РјР°СЂРё СѓСЃРїС–С€РЅРѕ РІС–РґРЅРѕРІР»РµРЅРѕ', ru: 'Р”Р°РЅРЅС‹Рµ РёР· РѕР±Р»Р°РєР° СѓСЃРїРµС€РЅРѕ РІРѕСЃСЃС‚Р°РЅРѕРІР»РµРЅС‹', en: 'Data successfully restored from cloud' },
      local_lists_create: { uk: 'РЎС‚РІРѕСЂРёС‚Рё СЃРїРёСЃРѕРє', ru: 'РЎРѕР·РґР°С‚СЊ СЃРїРёСЃРѕРє', en: 'Create list' },
      local_lists_new_name: { uk: 'РќР°Р·РІР° СЃРїРёСЃРєСѓ', ru: 'РќР°Р·РІР°РЅРёРµ СЃРїРёСЃРєР°', en: 'List name' },
      local_lists_added: { uk: 'Р”РѕРґР°РЅРѕ', ru: 'Р”РѕР±Р°РІР»РµРЅРѕ', en: 'Added' },
      local_lists_removed: { uk: 'Р’РёР»СѓС‡РµРЅРѕ', ru: 'РЈРґР°Р»РµРЅРѕ', en: 'Removed' },
      local_lists_remove_item: { uk: 'Р’РёР»СѓС‡РёС‚Рё СЃРїРёСЃРѕРє', ru: 'РЈРґР°Р»РёС‚СЊ СЃРїРёСЃРѕРє', en: 'Remove list' },
      local_lists_remove_card: { uk: 'Р’РёР»СѓС‡РёС‚Рё С„С–Р»СЊРј', ru: 'РЈРґР°Р»РёС‚СЊ С„РёР»СЊРј', en: 'Remove movie' },
      local_lists_import_trakt: { uk: 'Р†РјРїРѕСЂС‚ Р· Trakt.tv', ru: 'РРјРїРѕСЂС‚ СЃ Trakt.tv', en: 'Import from Trakt.tv' },
      local_lists_import_pick_file: { uk: 'РћР±РµСЂС–С‚СЊ ZIP-Р°СЂС…С–РІ РµРєСЃРїРѕСЂС‚Сѓ Trakt.tv', ru: 'Р’С‹Р±РµСЂРёС‚Рµ ZIP-Р°СЂС…РёРІ СЌРєСЃРїРѕСЂС‚Р° Trakt.tv', en: 'Select Trakt.tv export ZIP' },
      local_lists_import_reading: { uk: 'Р§РёС‚Р°СЋ Р°СЂС…С–РІвЂ¦', ru: 'Р§РёС‚Р°СЋ Р°СЂС…РёРІвЂ¦', en: 'Reading archiveвЂ¦' },
      local_lists_import_progress: { uk: 'Р†РјРїРѕСЂС‚СѓСЋ СЃРїРёСЃРєРёвЂ¦', ru: 'РРјРїРѕСЂС‚РёСЂСѓСЋ СЃРїРёСЃРєРёвЂ¦', en: 'Importing listsвЂ¦' },
      local_lists_import_done: { uk: 'Р†РјРїРѕСЂС‚ Р·Р°РІРµСЂС€РµРЅРѕ', ru: 'РРјРїРѕСЂС‚ Р·Р°РІРµСЂС€С‘РЅ', en: 'Import complete' },
      local_lists_import_error: { uk: 'РќРµ РІРґР°Р»РѕСЃСЏ РїСЂРѕС‡РёС‚Р°С‚Рё Р°СЂС…С–РІ', ru: 'РќРµ СѓРґР°Р»РѕСЃСЊ РїСЂРѕС‡РёС‚Р°С‚СЊ Р°СЂС…РёРІ', en: 'Failed to read archive' },
      local_lists_import_no_lists: { uk: 'РЈ Р°СЂС…С–РІС– РЅРµ Р·РЅР°Р№РґРµРЅРѕ С„Р°Р№Р» lists-lists.json', ru: 'Р’ Р°СЂС…РёРІРµ РЅРµ РЅР°Р№РґРµРЅ С„Р°Р№Р» lists-lists.json', en: 'lists-lists.json not found in archive' },
      local_lists_edit_menu: { uk: 'Р РµРґР°РіСѓРІР°С‚Рё СЃРїРёСЃРєРё', ru: 'Р РµРґР°РєС‚РёСЂРѕРІР°С‚СЊ СЃРїРёСЃРєРё', en: 'Edit Lists' },
      local_lists_synced: { uk: 'РЎРёРЅС…СЂРѕРЅС–Р·РѕРІР°РЅРѕ', ru: 'РЎРёРЅС…СЂРѕРЅРёР·РёСЂРѕРІР°РЅРѕ', en: 'Synced' },
      local_lists_not_found: { uk: 'РќРµ Р·РЅР°Р№РґРµРЅРѕ', ru: 'РќРµ РЅР°Р№РґРµРЅРѕ', en: 'Not found' },
      local_lists_invalid_backup: { uk: 'РќРµРєРѕСЂРµРєС‚РЅС– РґР°РЅС– Р±РµРєР°РїСѓ', ru: 'РќРµРєРѕСЂСЂРµРєС‚РЅС‹Рµ РґР°РЅРЅС‹Рµ Р±СЌРєР°РїР°', en: 'Invalid backup data' },
      local_lists_github_error: { uk: 'РџРѕРјРёР»РєР° GitHub', ru: 'РћС€РёР±РєР° GitHub', en: 'GitHub Error' }
    });
  }
  ...
  var Lists = {
    ...
    get: function (id) { var all = this.getAll(); for (var i = 0; i < all.length; i++) if (all[i].id === id) return all[i]; return null; },
  ...
  // в”Ђв”Ђ Smart Merge (Р·Р±РµСЂРµР¶РµРЅРЅСЏ hidden РїС–Рґ С‡Р°СЃ СЃРёРЅС…СЂРѕРЅС–Р·Р°С†С–С—) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  ...
  // в”Ђв”Ђ GitHub Cloud в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  var Cloud = {
    checkAuth: function () {
      ...
      $.ajax({
        ...
        error: function (xhr) {
          if (errorCallback) {
            ...
            Lampa.Loading.stop();
            Lampa.Noty.show(tr('local_lists_github_error') + ' (' + (xhr ? xhr.status : 'unknown') + ')');
          }
        }
      });
    },
      ...
      if (id) {
        this.request('GET', 'https://api.github.com/gists/' + id, null, function (res) {
          ...
          if (xhr && xhr.status === 404) {
            ...
            Lampa.Loading.stop();
            Lampa.Noty.show(tr('local_lists_github_error'));
          }
        });
      } else {
    ...
    overwrite: function () {
      ...
      Lampa.Select.show({
        ...
        items: [
          { title: (Lampa.Lang && Lampa.Lang.translate('settings_param_yes')) || 'РўР°Рє', id: 'yes' },
          { title: (Lampa.Lang && Lampa.Lang.translate('settings_param_no')) || 'РќС–', id: 'no' }
        ],
        onSelect: function (a) {
          if (a.id === 'yes') {
            Lampa.Loading.start();
        ...
        onSelect: function (a) {
          if (a.id === 'yes') {
            ...
            _this.getGist(function (gist) {
              if (!gist || !gist.files) {
                Lampa.Loading.stop();
                Lampa.Noty.show(tr('local_lists_not_found'));
                return;
              }
              ...
              if (!remoteLists && !remoteFav) {
                Lampa.Loading.stop();
                Lampa.Noty.show(tr('local_lists_invalid_backup'));
                return;
              }
  ...
  // в”Ђв”Ђ Trakt.tv Import в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  var TraktImport = {
    _jszipPromise: null,
      ...
      return new Promise(function (resolve) {
        ...
        function runNext() {
          ...
          while (active < limit && next < items.length) {
            (function (i) {
              active++; next++;
              Promise.resolve(iterator(items[i])).then(function (r) {
                results[i] = r;
              }).catch(function () {
                results[i] = null;
              }).then(function () {
  ...
  // в”Ђв”Ђ Shared content controller helper в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  function bindContentController(scroll, body, onBack) {
    Lampa.Controller.add('content', {
      ...
      back: onBack || function () { Lampa.Activity.backward(); }
    });
    Lampa.Controller.toggle('content');
  }

  // в”Ђв”Ђ РљРѕРјРїРѕРЅРµРЅС‚ СЂРµРґР°РіСѓРІР°РЅРЅСЏ (РїРѕСЂСЏРґРѕРє, РїСЂРёС…РѕРІСѓРІР°РЅРЅСЏ) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  function EditListsComponent() {
    ...
    this.build = function (targetFocus) {
      ...
      if (lists.length === 0) {
        body.append('<div class="empty__title" style="padding: 3em; text-align: center; opacity: 0.5;">' + (tr('empty_title') || 'РџРѕСЂРѕР¶РЅСЊРѕ') + '</div>');
      }
      ...
      // Р’С–РґРЅРѕРІР»РµРЅРЅСЏ С„РѕРєСѓСЃСѓ РЅР° РєРѕРЅРєСЂРµС‚РЅС–Р№ РєРЅРѕРїС†С– РїС–СЃР»СЏ РїРµСЂРµРјС–С‰РµРЅРЅСЏ
      Lampa.Controller.collectionSet(scroll.render());
    ...
    this.start = function () {
      bindContentController(scroll, body);
    };
    ...
    this.destroy = function () {
      scroll.destroy();
      html.remove();
      // РћРЅРѕРІРёС‚Рё РїРѕРїРµСЂРµРґРЅС–Р№ РµРєСЂР°РЅ РїСЂРё РїРѕРІРµСЂРЅРµРЅРЅС–
      var cur = Lampa.Activity.active();
      if (cur && (cur.component === 'bookmarks' || cur.component === 'local_lists_root')) {
        Lampa.Activity.replace();
      }
  ...
  // в”Ђв”Ђ РќР°Р»Р°С€С‚СѓРІР°РЅРЅСЏ в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  function registerSettings() {
  if (!Lampa.SettingsApi) return;

  // 1. Р РµС”СЃС‚СЂСѓС”РјРѕ РіРѕР»РѕРІРЅРёР№ СЂРѕР·РґС–Р» Сѓ РќР°Р»Р°С€С‚СѓРІР°РЅРЅСЏС…
  ...
  // 2. РџСѓРЅРєС‚: Р РµРґР°РіСѓРІР°С‚Рё СЃРїРёСЃРєРё (РїРѕСЂСЏРґРѕРє, РїСЂРёС…РѕРІСѓРІР°РЅРЅСЏ)
  Lampa.SettingsApi.addParam({
    ...
    field: {
      ...
      description: 'Р—РјС–РЅР° РїРѕСЂСЏРґРєСѓ РІС–РґРѕР±СЂР°Р¶РµРЅРЅСЏ С‚Р° РїСЂРёС…РѕРІСѓРІР°РЅРЅСЏ СЃРїРёСЃРєС–РІ'
    },
    onChange: function () {
      Lampa.Activity.push({
  ...
  Lampa.SettingsApi.addParam({
    ...
    field: {
      ...
      description: 'РќР°С‚РёСЃРЅС–С‚СЊ, С‰РѕР± РІРІРµСЃС‚Рё РѕСЃРѕР±РёСЃС‚РёР№ С‚РѕРєРµРЅ GitHub'
    },
    onRender: function (item) {
      // Р’С–РґРѕР±СЂР°Р¶Р°С”РјРѕ Р°РєС‚СѓР°Р»СЊРЅРёР№ СЃС‚Р°С‚СѓСЃ С‚РѕРєРµРЅР°
      var token = Lampa.Storage.get(GIST_TOKEN_KEY, '');
      var label = token ? 'вЂўвЂўвЂўвЂўвЂўвЂўвЂўвЂў' : '---';
    ...
    onChange: function () {
      Lampa.Input.edit({
        ...
        Lampa.Settings.update(); // Р°РІС‚РѕРјР°С‚РёС‡РЅРѕ РѕРЅРѕРІРёС‚СЊ РЅР°РїРёСЃ
      });
    }
  });

  // 4. РџСѓРЅРєС‚: РЎРёРЅС…СЂРѕРЅС–Р·СѓРІР°С‚Рё Р· С…РјР°СЂРѕСЋ
  Lampa.SettingsApi.addParam({
    component: 'local_lists_settings',
    param: {
      name: 'll_param_sync',
    ...
    field: {
      ...
      description: 'РћР±\'С”РґРЅР°С‚Рё Р»РѕРєР°Р»СЊРЅС– СЃРїРёСЃРєРё С– Р·Р°РєР»Р°РґРєРё Р· С…РјР°СЂРѕСЋ GitHub'
    },
    onChange: function () {
      Cloud.backup();
    }
  ...
  // 5. РџСѓРЅРєС‚: РџРµСЂРµР·Р°РїРёСЃР°С‚Рё РІ С…РјР°СЂС–
  Lampa.SettingsApi.addParam({
    component: 'local_lists_settings',
    param: {
    ...
    field: {
      ...
      description: 'Р—Р°РјС–РЅРёС‚Рё РІСЃС– РґР°РЅС– РІ С…РјР°СЂС– РїРѕС‚РѕС‡РЅРёРјРё Р»РѕРєР°Р»СЊРЅРёРјРё СЃРїРёСЃРєР°РјРё'
    },
    onChange: function () {
      Cloud.overwrite();
    }
  ...
  // 6. РџСѓРЅРєС‚: Р’С–РґРЅРѕРІРёС‚Рё Р· С…РјР°СЂРё
  Lampa.SettingsApi.addParam({
    component: 'local_lists_settings',
    param: {
    ...
    field: {
      ...
      description: 'РџРѕРІРЅС–СЃС‚СЋ Р·Р°РјС–РЅРёС‚Рё Р»РѕРєР°Р»СЊРЅС– СЃРїРёСЃРєРё РґР°РЅРёРјРё Р· С…РјР°СЂРё'
    },
    onChange: function () {
      Cloud.restore();
    }
  ...
  // 7. РџСѓРЅРєС‚: Р†РјРїРѕСЂС‚ Р· Trakt.tv
  Lampa.SettingsApi.addParam({
    component: 'local_lists_settings',
    param: {
      name: 'll_param_trakt',
    ...
    field: {
      ...
      description: 'Р†РјРїРѕСЂС‚СѓРІР°С‚Рё СЃРїРёСЃРєРё Р· Р°СЂС…С–РІСѓ РµРєСЃРїРѕСЂС‚Сѓ Trakt.tv (.zip)'
    },
    onChange: function () {
      TraktImport.run();
    }
  ...
  // в”Ђв”Ђ РљРѕРјРїРѕРЅРµРЅС‚Рё С–РЅС‚РµСЂС„РµР№СЃСѓ в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  ...
  function DetailComponent(object) {
    ...
    this.build = function () {
      ...
      if (list && list.items && list.items.length) {
        ...
        var empty = $('<div class="empty__title" style="padding: 3em; text-align: center; opacity: 0.5; font-size: 1.3em;">' + (tr('empty_title') || 'РџРѕСЂРѕР¶РЅСЊРѕ') + '</div>');
        body.append(empty);
      }
  ...
  // в”Ђв”Ђ Р СЏРґРѕРє В«РњРѕС— СЃРїРёСЃРєРёВ» Сѓ СЂРѕР·РґС–Р»С– В«Р—Р°РєР»Р°РґРєРёВ» в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  ...
  var _cardHandlersTimer = null;
  var _cardHandlersAttempts = 0;
  ...
  function applyRowCardHandlers() {
    ...
    $cards.each(function (index) {
      ...
      // Only rebind if not yet processed for this list set
      if ($card.data('ll-bound') === lists.length && index < lists.length) {
        var existingId = $card.data('local-list-id');
        if (existingId && lists[index] && existingId === lists[index].id) return;
      }
      ...
      if (index < lists.length) {
        ...
        $card.removeClass('local-lists-card-add');
        $card.data('local-list-id', list.id);
        $card.data('ll-bound', lists.length);

        var $badge = $card.find('.local-lists-counter-badge');
        ...
        $card.removeClass('local-lists-card');
        $card.removeData('local-list-id');
        $card.data('ll-bound', lists.length);
        $card.find('img, .card__img-broken, .local-lists-counter-badge').remove();
  ...
  function scheduleCardHandlers() {
    if (_cardHandlersTimer) clearTimeout(_cardHandlersTimer);
    _cardHandlersAttempts = 0;

    function tryApply() {
      if (applyRowCardHandlers() || _cardHandlersAttempts >= 6) return;
      _cardHandlersAttempts++;
      _cardHandlersTimer = setTimeout(tryApply, _cardHandlersAttempts < 3 ? 50 : 200);
    }
    tryApply();
  }
  ...
  // в”Ђв”Ђ Р›РѕРЅРі-С‚Р°Рї РЅР° РєР°СЂС‚С†С– РІ РєР°С‚Р°Р»РѕР·С– в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  ...
  // в”Ђв”Ђ РњРµРЅСЋ В«Р’РёР±СЂР°РЅРµВ» Сѓ РєР°СЂС‚С†С– С„С–Р»СЊРјСѓ (РєРЅРѕРїРєР° Р·Р°РєР»Р°РґРєРё) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  ...
  function startPlugin() {
    ...
    $('body').append(
      '<style>' +
        ...
        /* РљР°СЂС‚РєР° СЃС‚РІРѕСЂРµРЅРЅСЏ СЃРїРёСЃРєСѓ (+) */
        ...
        /* Р‘РµР№РґР¶ С–Р· Р»С–С‡РёР»СЊРЅРёРєРѕРј */
        ...
        /* РњРµРЅСЋ РЅР°Р»Р°С€С‚СѓРІР°РЅСЊ */
        ...
        /* РњРµРЅСЋ СЂРµРґР°РіСѓРІР°РЅРЅСЏ СЃРїРёСЃРєС–РІ (РїРѕСЂСЏРґРѕРє, РїСЂРёС…РѕРІСѓРІР°РЅРЅСЏ) */
    ...
    $(document).on('hover:focus.local_lists', '.card', function () {
      var $card = $(this);
      if ($card.hasClass('local-lists-card') || $card.hasClass('local-lists-card-add') ||
          $card.closest('.line, .card-line, .items-line').find('.line__title, .card-line__title, .items-line__title').text().trim() === tr('local_lists_title')) {
