(function () {
  ...
  function addLang() {
    ...
    Lampa.Lang.add({
      ...
      local_lists_synced: { uk: 'Синхронізовано', ru: 'Синхронизировано', en: 'Synced' },
      local_lists_not_found: { uk: 'Не знайдено', ru: 'Не найдено', en: 'Not found' },
      local_lists_invalid_backup: { uk: 'Некоректні дані бекапу', ru: 'Некорректные данные бэкапа', en: 'Invalid backup data' },
      local_lists_github_error: { uk: 'Помилка GitHub', ru: 'Ошибка GitHub', en: 'GitHub Error' }
    });
  }
  ...
  // ── Shared content controller helper ─────────────────────────────────
